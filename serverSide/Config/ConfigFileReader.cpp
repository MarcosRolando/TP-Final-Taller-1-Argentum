...
Config::ConfigFileReader::ConfigFileReader(const std::string& path) :
    ...
    races{{"Human", HUMAN}, {"Elf", ELF},{"Dwarf", DWARF},
          {"Gnome", GNOME}},
    monsters{{"Skeleton", SKELETON}, {"Zombie", ZOMBIE},{"Spider", SPIDER},
             {"Goblin", GOBLIN}},
    weapons{{"Longsword", LONGSWORD},{"Axe", AXE}, {"Warhammer", WARHAMMER},
            {"AshRod", ASH_ROD}, {"ElvenFlute", ELVEN_FLUTE},
            {"LinkedStaff", LINKED_STAFF},
            {"SimpleBow", SIMPLE_BOW}, {"CompositeBow", COMPOSITE_BOW},
            {"GnarledStaff", GNARLED_STAFF},
            {"Fist", FIST}},
    clothing{{"CommonClothing", COMMON_CLOTHING},{"LeatherArmor", LEATHER_ARMOR},
             {"PlateArmor", PLATE_ARMOR},
             {"KingArmor", KING_ARMOR},{"BlueTunic", BLUE_TUNIC},
             {"Hood", HOOD}, {"IronHelmet", IRON_HELMET},
            {"TurtleShield", TURTLE_SHIELD}, {"IronShield", IRON_SHIELD},
            {"MagicHat", MAGIC_HAT},
